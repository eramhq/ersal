 ...
 * quote, book, track, cancel. No label/pickup/COD — those are handled
 * by the underlying carrier Amadast routes to.
 */
final class AmadastProvider extends AbstractProvider implements ShippingInterface
{
    ...
    private function assertOk(array $response, string $operation): void
    {
        ...
        $code = (int) ($error['code'] ?? 6999);
        $errorEnum = AmadastErrorCode::tryFrom($code);
